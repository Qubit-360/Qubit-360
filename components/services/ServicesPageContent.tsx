...
export default function ServicesPageContent({ services }: ServicesPageContentProps) {
    ...
    useGSAP(() => {
        ...
        rows.forEach((row, i) => {
            const isEven = i % 2 === 0;
            const imageSide = row.querySelector('.service-image');
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="space-y-24">
                    {services?.map((service, index) => {
                        ...
                        return (
                            <div key={service.title} className={`service-row flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
                                {/* Image/Visual Sider */}
                                <div className="service-image w-full lg:w-1/2">
                                ...
                                {/* Content Side */}
                                <div className="service-content w-full lg:w-1/2 space-y-6">
